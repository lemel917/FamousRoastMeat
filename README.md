...
- **燒臘拼盤與單點**：13 個品項各自一個開關。食材開關只管飯類主餐，不連動拼盤單品（叉燒一份/燒肉一份/油雞腿一隻等一律由拼盤區自己的開關控制）。
...
push 上 GitHub 後，GitHub Pages 會自動更新。**首次改版部署後務必**到後台按一次「全部恢復供應」：舊版（品項層級 b01 等）殘留的賣完鍵會誤標對應品項為賣完，按一次即可清除。
